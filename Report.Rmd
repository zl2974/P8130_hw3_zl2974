...
\end{aligned}$$
  ...
  \ According to the critical value we choose(`r qt(0.975,70)`), we cannot reject $H_0$ that there's no difference between the difference of baseline systolic BP and 6 month later in intervention group and control group.

3) The testing in 1),2) are based on that sample is draw from a normal distributed population or the distributions fit normality. As ploted as follow, the sample distribution satisfied normality requirement for testing.
